...
We read these books on our phones using Moon+ reader. Whenever we feel like reading, we open Moon+ reader and read for a few minutes. We don't read books in a linear order. Instead, we jump between different sections, and also jump between books. We find this to be more fun. 
