# Using three-minute timers to get started

Whenever we lack motivation to work, we set a three-minute timer, during which we must work. After each three-minute interval, we either continue working or take a break, depending on how motivated we feel.  
